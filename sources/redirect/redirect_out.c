...
/*   Updated: 2021/12/23 15:35:23 by aldamien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void     redirection_out(char *name_file)
{
	...
	fd = open(name_file, O_CREAT | O_TRUNC | O_WRONLY, S_IROTH | S_IRGRP | S_IRUSR | S_IWGRP | S_IWUSR);
	if (fd == -1)
	{
...
// gestion du >>
// plutot que d'utiliser O_TRUNC, utilise O_APPEND - écrira la suite à la fin du fichier, plutôt que de le vider et de réécrire dessus.
